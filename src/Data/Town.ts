...
class Town
{
    ...
    private Init() : void
    {
        this.InitBackground();
        this._Floors.push(new Floor(null, 0));
        this._Base = TBX.SceneObjectUtil.CreateTile("Base", ["/Textures/Town/Base.png"], new TBX.Vertex(960, TOWN_CENTER+250), new TBX.Vertex(1000,2000));
        this._Grid = TBX.SceneObjectUtil.CreateTile("Grid", ["/Textures/Town/Grid.png"], new TBX.Vertex(960, TOWN_CENTER), new TBX.Vertex(1000,1000));
    ...
    {
        this._Sky = TBX.SceneObjectUtil.CreateTile("Sky", ["/Textures/Town/Sky.png"], new TBX.Vertex(960, TOWN_CENTER - 1624), new TBX.Vertex(1920,4320));
        this._Stars = TBX.SceneObjectUtil.CreateTile("Stars", ["/Textures/Town/Stars.png"], new TBX.Vertex(960, TOWN_CENTER - 1624), new TBX.Vertex(1920,4320));
        this._Clouds = TBX.SceneObjectUtil.CreateTile("Stars", ["/Textures/Town/Clouds.png"], new TBX.Vertex(960, TOWN_CENTER - 1624), new TBX.Vertex(1920,4320));
