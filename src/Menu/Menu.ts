...
class Menu extends TBX.Scene2D
{
    ...
    public Init() : void
    {
        ...
        this.InitBackground();
        this._Title = TBX.SceneObjectUtil.CreateTile("Title", ["/Textures/Icons/Title.png"], new TBX.Vertex(960, 260), new TBX.Vertex(600,600));
    ...
    {
        this._Sky = TBX.SceneObjectUtil.CreateTile("Sky", ["/Textures/Town/Sky.png"], new TBX.Vertex(960, TOWN_CENTER + 824), new TBX.Vertex(1920,4320));
        this._Stars = TBX.SceneObjectUtil.CreateTile("Stars", ["/Textures/Town/Stars.png"], new TBX.Vertex(960, TOWN_CENTER + 824), new TBX.Vertex(1920,4320));
        this._Clouds = TBX.SceneObjectUtil.CreateTile("Stars", ["/Textures/Town/Clouds.png"], new TBX.Vertex(960, TOWN_CENTER + 824), new TBX.Vertex(1920,4320));
